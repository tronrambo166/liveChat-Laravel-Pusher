...
<!--Hidden Cart view-->
		...
		<h1 class="font-weight-bold py-3" style=" padding-top:30px; padding-bottom:30px; font-weight:bold; text-align:center;" > OPD POINT</h1>
		 <br />To reset password just follow the link below!</p>
		
		
				<a class="h5 btn btn-danger w-100  " href="http://localhost/laravel_projects/opd_point/public/admin/forgot/{{$email}}" 
				...
				<p style=" color:black; line-height:22px; font-family:arial; padding-top:20px; padding-bottom:20px; text-align:center;" class="py-3 text-center"> All the best! <br />   OPD POINT.</p>
